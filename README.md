...
<body>
  ...
  <form>
    <fieldset>
      ...
      <br>
      <input type="checkbox" name="value1" valuel="valuel">Papaya salad
      <input type="checkbox" name="value2" valuel="value2">Roast chicken
      <input type="checkbox" name="value3" valuel="value3">Steamed chicken with rice
      <br>
  ...
  <br>
  <iframe width="560" height="315" src="https://www.youtube.com/embed/Sp8khePBKUk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
